...
abstract class Native {
  RwLockRawSpeaker speakerNew({required String ip, dynamic hint});

  FlutterRustBridgeTaskConstMeta get kSpeakerNewConstMeta;

  Stream<Update> speakerConnect({required RwLockRawSpeaker x, dynamic hint});

  FlutterRustBridgeTaskConstMeta get kSpeakerConnectConstMeta;

  bool speakerIsConnected({required RwLockRawSpeaker x, dynamic hint});

  FlutterRustBridgeTaskConstMeta get kSpeakerIsConnectedConstMeta;

  Future<void> speakerPing({required RwLockRawSpeaker x, dynamic hint});
...
class Update with _$Update {
  const factory Update.info(
    MachineInfo field0,
  ) = Update_Info;
  const factory Update.ping(
    Ping field0,
  ) = Update_Ping;
}
...
class NativeImpl implements Native {
  ...
  RwLockRawSpeaker speakerNew({required String ip, dynamic hint}) {
    ...
    return _platform.executeSync(FlutterRustBridgeSyncTask(
      callFfi: () => _platform.inner.wire_speaker_new(arg0),
  ...
  Stream<Update> speakerConnect({required RwLockRawSpeaker x, dynamic hint}) {
    ...
    return _platform.executeStream(FlutterRustBridgeTask(
      ...
      parseSuccessData: _wire2api_update,
  ...
  bool speakerIsConnected({required RwLockRawSpeaker x, dynamic hint}) {
    var arg0 = _platform.api2wire_RwLockRawSpeaker(x);
    return _platform.executeSync(FlutterRustBridgeSyncTask(
      callFfi: () => _platform.inner.wire_speaker_is_connected(arg0),
...
// Section: wire2api
  ...
  Ping _wire2api_box_autoadd_ping(dynamic raw) {
    return _wire2api_ping(raw);
  }
  ...
  MachineInfo _wire2api_machine_info(dynamic raw) {
    ...
    return MachineInfo(
      ...
      mac: _wire2api_String(arr[1]),
      os: _wire2api_String(arr[2]),
    );
  }

  Ping _wire2api_ping(dynamic raw) {
    final arr = raw as List<dynamic>;
    if (arr.length != 1)
  ...
  Update _wire2api_update(dynamic raw) {
    switch (raw[0]) {
      case 0:
        return Update_Info(
          _wire2api_box_autoadd_machine_info(raw[1]),
        );
      case 1:
        return Update_Ping(
          _wire2api_box_autoadd_ping(raw[1]),
        );
      default:
...
class NativeWire implements FlutterRustBridgeWireBase {
  ...
  WireSyncReturn wire_speaker_new(
  ...
  late final _wire_speaker_newPtr = _lookup<
      ffi.NativeFunction<
          WireSyncReturn Function(
              ffi.Pointer<wire_uint_8_list>)>>('wire_speaker_new');
  ...
  WireSyncReturn wire_speaker_is_connected(
    wire_RwLockRawSpeaker x,
  ) {
  ...
  late final _wire_speaker_is_connectedPtr = _lookup<
          ffi.NativeFunction<WireSyncReturn Function(wire_RwLockRawSpeaker)>>(
      'wire_speaker_is_connected');
  late final _wire_speaker_is_connected = _wire_speaker_is_connectedPtr
      .asFunction<WireSyncReturn Function(wire_RwLockRawSpeaker)>();
